...
from .views import RegisterView, LogoutView, MeView, AddFriendView, MutualFriendsView,FriendRequestListView,SendFriendRequestView, AcceptFriendRequestView, CookieTokenObtainPairView
